...
const hexagonElements: HexagonElement[] = [
  {
    ...
    content: {
      title: 'Direction',
      description: 'It's all about being very clear in which direction you are heading and what you want to achieve. This clarity must extend not just to the founders or the leadership team, but to everyone in your company. Whatever you call it — mission, purpose, north star, etc. — without a clear direction, startups often lose focus and struggle to make consistent progress.'
    }
  },
  {
    id: 'execution',
  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start lg:items-start">
        ...
        <div className="space-y-8 lg:pl-4 flex-1 max-w-xl">
