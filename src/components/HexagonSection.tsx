  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start lg:items-start">
        {/* Hexagon on the left */}
        <div className="flex justify-center lg:justify-start flex-shrink-0 lg:-mt-32">
                ...
                return (
                  <g key={element.id}>
                    ...
                    <text
                      ...
                      y={y + 5}
                      textAnchor="middle"
                      className={`text-sm font-medium cursor-pointer transition-all duration-300 hover:fill-accent1 ${
        ...
        <div className="space-y-8 lg:pl-4 flex-1 max-w-xl">
          ...
          {/* Element indicators */}
          <div className="flex flex-nowrap gap-2 mt-8 overflow-x-auto">
